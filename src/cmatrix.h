...
typedef enum {
        e_forward, e_backward, e_inverse
} e_FFTDIR;

// FFT direction enums:
// For the MKL:
//      e_forward:      isign = FFTW_FORWARD
//      e_backward:     isign = FFTW_BACKWARD (e_backward is a non-scaled GSL parameter)
//      e_inverse       isign = FFTW_BACKWARD
...
//////---------->
    ...
    CMatrix(   const CMatrix<_CMDATA>& x);
    //  copy initializer
    ~CMatrix();
...
//////---------->
    ...
    CMatrix(    const CMatrix<GSL_complex>& x);
    //  copy initializer
    ~CMatrix();
    void    coreMatrix_destruct();
    //  destructor
...
//////---------->
    ...
    CMatrix(    const CMatrix<GSL_complex_float>& x);
    //  copy initializer
    ~CMatrix();
    void    coreMatrix_destruct();
    //  destructor
